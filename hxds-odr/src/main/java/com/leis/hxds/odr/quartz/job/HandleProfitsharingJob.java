package com.leis.hxds.odr.quartz.job;
...
import com.leis.hxds.common.wxpay.WXPayConstants;
...
public class HandleProfitsharingJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            //分账金额从元转换成分
            int amount =
                    Integer.parseInt(NumberUtil.mul(driverIncome, "100").setScale(0, RoundingMode.FLOOR).toString());
            ...
            //执行分账请求
            String response = wxPay.requestWithoutCert(url, param, 3000, 3000);
            log.debug(response);
